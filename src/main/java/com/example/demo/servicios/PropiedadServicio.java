...
public class PropiedadServicio {
    ...
    public Propiedad guardarPropiedad(Propiedad propiedad) {
        ...
        if (esNuevo) {
            ...
            if ((propiedad.getEstado() == EstadoPropiedad.DISPONIBLE || 
                ...
                if (contratoRepositorio.existsByPropiedadAndEstadoAndEliminadoFalse(propiedad, EstadoContrato.ACTIVO)) {
    ...
    public void eliminarPropiedad(Integer id) { 
        ...
        boolean tieneContratos = contratoRepositorio.existsByPropiedadAndEstadoAndEliminadoFalse(propiedad, EstadoContrato.ACTIVO);
