...
//	clave primaria
	...
	// Indica si el contrato ha sido eliminado (eliminación lógica). Se usa para marcar el contrato sin borrarlo físicamente de la base de datos
	// en vez de borrarlo de la base, cambia el valor a true y así podés mantener el registro, pero ocultarlo de las operaciones normales. 
	// Los getters y setters te permiten leer y modificar ese estado cuando lo necesites, sin perder la información.
	...
	// constructor vacio publico, Spring Boot (a través de JPA/Hibernate) necesita poder crear objetos de Contrato automáticamente 
